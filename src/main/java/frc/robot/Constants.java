...
// FIX ME IDS
    ...
    public static final double Front_LeftSTEER_Offset = -Math.toRadians(323 - 90);
//ADD  FOR FR to make turn left and subtract to turn right
    ...
    public static double Front_RightSTEER_Offset = -Math.toRadians(70);
//24.5
